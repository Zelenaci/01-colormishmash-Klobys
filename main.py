...
class Application(tk.Tk):
    ...
    def __init__(self):
        ...
        self.lblR.pack()
        self.scaleR = Scale(from_=0, to=255, orient=tk.HORIZONTAL, length=256, command=self.change)
        self.scaleR.pack()

        self.lblG = tk.Label(self, text="G")
        self.lblG.pack()
        self.scaleG = Scale(from_=0, to=255, orient=tk.HORIZONTAL, length=256, command=self.change)
        self.scaleG.pack()

        self.lblB = tk.Label(self, text="B")
        self.lblB.pack()
        self.scaleB = Scale(from_=0, to=255, orient=tk.HORIZONTAL, length=256, command=self.change)
        self.scaleB.pack()
